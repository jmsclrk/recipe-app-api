...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@jamesclark.com', password='testpass')
        payload = {'email': 'test@jamesclark.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        """Test the token is not created if user does not exist"""
        payload = {
            'email': 'test@jamesclark.com',
            'password': 'testpass',
        }
    ...
    def test_create_token_missing_field(self):
        ...
        res = self.client(TOKEN_URL, {'email': 'one', 'password': ''})
